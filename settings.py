# Django settings for gsportstracker project.

DEBUG = True
#TEMPLATE_DEBUG = FALSE

ADMINS = (
    ('Ian Lawrence', 'ian.lawrence@openbossa.org'),
)
...
MEDIA_URL = 'http://innova.indt.org/media'
...
SECRET_KEY = ')t&4u(9p#!n1htvpq_tg!6#h#$36bf0z$fsopsh&gru(^qxwbl'
